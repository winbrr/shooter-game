...
local defaultWeapon = weaponClass.new("Pistol", 0.2, 10, 1, 1500, "assets/sprites/guns/G19.png", "special", 25)
local defaultWeapon2 = weaponClass.new("Rifle", 0.1, 5, 1, 1500, "assets/sprites/guns/F1.png", "medium", 35)
